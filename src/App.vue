...
import { useInitialScrollRestore } from "./composables/useInitialScrollRestore";
import { useLazySectionMounting } from "./composables/useLazySectionMounting";
...
const { showGallery, showAboutUs, showWhyChooseUs, showTestimonials, showFooter, revealSectionsUpTo } =
  useLazySectionMounting({
    gallery: loadSectionGallery,
    aboutUs: loadSectionAboutUs,
    whyChooseUs: loadSectionWhyChooseUs,
    testimonials: loadSectionTestimonials,
    footer: loadAppFooter,
  });

useDialogA11y(phoneDialogOpen, phoneDialogRef, () => {
  phoneDialogOpen.value = false;
});
useInitialScrollRestore({ revealSectionsUpTo });
