...
// Computed properties for locale-specific products
const cakes = computed(() => (locale.value === "en" ? cakesEn : cakesRo));
const cookies = computed(() => (locale.value === "en" ? cookiesEn : cookiesRo));
const pastry = computed(() => (locale.value === "en" ? pastryEn : pastryRo));
...
<template>
  <AppTabs :key="locale">
    <AppTab :title="t('catalog.cakes')" tab-key="torturi">
    ...
    <AppTab :title="t('catalog.pastries')" tab-key="prajituri">
    ...
    <AppTab :title="t('catalog.bakery')" tab-key="patiserie">
      <SectionCatalogGallery :data="pastry" />
    </AppTab>
    <AppTab :title="t('catalog.events')" tab-key="evenimente" class="container">
      <div
